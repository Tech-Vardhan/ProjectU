...
export class AuthService {
  ...
  login(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBoZdyQLDcUnV7A1tshXLY6w1Ct3qD2IQU',
        {
          email: email,
          password: password,
  ...
  signup(email: string, password: string) {
    return this.http
      .post<AuthResponseData>(
        'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBoZdyQLDcUnV7A1tshXLY6w1Ct3qD2IQU',
        {
          email: email,
          password: password,
          returnSecuredToken: true,
